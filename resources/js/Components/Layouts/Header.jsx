...
const Header = ({ user }) => {
  ...
  const isSidebarOpen = window.innerWidth >= 1024 ? isExpanded : isMobileOpen;

  return (
    <header className="sticky top-0 flex w-full bg-white border-gray-200 z-99999 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-4">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-2 border-b border-gray-200 dark:border-gray-800 sm:gap-3 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-2">
          <button
            className={`items-center justify-center w-8 h-8 text-gray-500 border border-gray-200 rounded-lg z-99999 flex dark:text-gray-400 ${!isSidebarOpen ? 'bg-gray-100 dark:bg-white/[0.03]' : ''
              }`}
            ...
            {isSidebarOpen ? (
              ...
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M6.21967 6.21967C6.51256 5.92678 6.98744 5.92678 7.28033 6.21967L12 10.9393L16.7176 6.21967C17.0105 5.92678 17.4854 5.92678 17.7782 6.21967C18.0711 6.51256 18.0711 6.98744 17.7782 7.28033L13.0597 12L17.7782 16.7187C18.0711 17.0116 18.0711 17.4863 17.7782 17.7792C17.4854 18.0721 17.0105 18.0721 16.7176 17.7792L11.999 13.0607L7.28033 17.7792C6.98744 18.0721 6.51256 18.0721 6.21967 17.7792C5.92678 17.4863 5.92678 17.0116 6.21967 16.7187L10.9384 12L6.21967 6.21967Z"
                  fill="currentColor"
                />
              </svg>
            ) : (
